...
__C.DATASETS.SHAPENET.TAXONOMY_FILE_PATH = './datasets/ShapeNetRendering.json'
__C.DATASETS.SHAPENET.TRAIN_RENDERING_PATH = '/data/ShapeNetRendering/image_align/%s/%s/%02d.png'
__C.DATASETS.SHAPENET.TEST_RENDERING_PATH = '/data/ShapeNetRendering/image_half/%s/%s/%02d.png'
__C.DATASETS.SHAPENET.FINETUNE_RENDERING_PATH = '/data/shapenet_trainset_augmentation/%s/%s/%02d.png'
__C.DATASETS.SHAPENET.VOXEL_PATH = '/data/ShapeNetVox32/%s/%s/model.binvox'
...
__C.NETWORK.ENCODER.VIT.USE_CLS_TOKEN = False
# Decoder
...
__C.TRAIN.VAL_FREQ = 5  # do a validation loop every val_freq epoch
__C.TRAIN.FINETUNE = False
__C.TRAIN.FINETUNE_RATE = 1
