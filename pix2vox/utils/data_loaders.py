...
class ShapeNetDataLoader:
    def __init__(self, cfg):
        ...
        if cfg.TEST.ROTATION:
            self.rendering_image_path_template = cfg.DATASETS.SHAPENET.TEST_RENDERING_PATH
        elif cfg.TRAIN.FINETUNE:
            self.rendering_image_path_template = cfg.DATASETS.SHAPENET.FINETUNE_RENDERING_PATH
        else:
        ...
        if cfg.TRAIN.FINETUNE:
            with open(cfg.DATASETS.SHAPENET.FINETUNE_TAXONOMY_FILE_PATH, encoding='utf-8') as file:
