...
def run_demo(
        ...
        ckpt='105000.ckpt',
        config='configs/sd-shapenet-finetune-c_concat-256.yaml'):
    ...
    demo.launch(enable_queue=True, share=True, server_name='127.0.0.1', server_port=7788)
